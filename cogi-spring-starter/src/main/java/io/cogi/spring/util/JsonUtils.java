...
import io.cogi.spring.util.matcher.JsonRequestMatcher;
...
public class JsonUtils {
    ...
    /**
     * {@link JsonUtils#isJsonRequest} 에서 사용함
     */
    private static JsonRequestMatcher defaultJsonRequestMatcher = new JsonRequestMatcher();
    ...
    public static boolean isJsonRequest(HttpServletRequest request) {
        return isJsonRequest(request, defaultJsonRequestMatcher);
    }
     ...
     * @return true or false
     */
    public static boolean isJsonRequest(HttpServletRequest request, JsonRequestMatcher matcher) {
